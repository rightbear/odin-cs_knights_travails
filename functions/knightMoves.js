...
function knightMoves(start, end) {
  ...
  if (!Array.isArray(start) || !Array.isArray(end)) {
    console.log(
      "The start and end positions should be a pair of coordinates like [x, y]",
    );
    return null;
  }
  ...
  if (
    ...
    console.log(
      "The x and y coordinates of start and end positions should be between 0 and 7",
    );
    return null;
  }
  ...
  // array to keep track of the traversal to the current node (each node has their own tracking array)
  let result = [];
